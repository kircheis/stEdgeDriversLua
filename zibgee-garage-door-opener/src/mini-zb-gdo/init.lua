...
-- Mini zigbee garage door operator
local MINI_ZIGBEE_GARAGE_DOOR_FINGERPRINTS = {
  { mfr = "MINI", model = "Mini Garage Door Opener"},
}
...
local is_zigbee_garage_door_opener = function(opts, driver, device)
  for _, fingerprint in ipairs(ZIGBEE_GARAGE_DOOR_OPENER_FINGERPRINTS) do
